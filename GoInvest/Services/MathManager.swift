...
struct MathManager {
    ...
    static func sma(points: [PointModel], windowSize: Int = 20) -> [PointModel] {
    ...
    static func ema(points: [PointModel], windowSize: Int = 20) -> [PointModel] {
        guard !points.isEmpty && windowSize > 0 else {
            return []
        }
    ...
    static func rsi(points: [PointModel], windowSize: Int = 20) -> [PointModel] {
    ...
    static func bollingerBands(points: [PointModel], windowSize: Int = 20) -> [PointModel] {
        guard !points.isEmpty && windowSize > 0 else {
            return []
        }
